...
Look at the absolute values of the residuals; what are the largest differences between the predicted result and the actual math scores? How would you describe the schools with the largest residuals?
